  ...
  return (
    <div className='todoDivArea'>
        <form className='todoDiv'>
            <input type="text" className='form-control todoText mb-3' name='title' 
            placeholder='Başlık' value={task.title} onChange={detectChange}/>

            <textarea name="content" className='form-control todoText mb-3' rows="3" placeholder='İşinizi yazınız..'
