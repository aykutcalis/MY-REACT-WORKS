...
<Avatar src='https://randomuser.me/api/portraits/men/56.jpg'/>
        ...
        <AvatarGroup max={4}>
<Avatar sx={{marginRight:10,bgcolor:'primary.light',width:70,height:70}}> Aykut</Avatar>
<Avatar variant='rounded' sx={{marginRight:10,bgcolor:'success.light',width:70,height:70}}>Tuğba</Avatar>
<Avatar sx={{marginRight:10,bgcolor:'primary.light',width:70,height:70}}> Aykut</Avatar>
<Avatar variant='rounded' sx={{marginRight:10,bgcolor:'success.light',width:70,height:70}}>Tuğba</Avatar>
<Avatar sx={{marginRight:10,bgcolor:'primary.light',width:70,height:70}}> Aykut</Avatar>
<Avatar variant='rounded' sx={{marginRight:10,bgcolor:'success.light',width:70,height:70}}>Tuğba</Avatar>
